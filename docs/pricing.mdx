...
description: "Hosted ForeverBetter API plans, limits, billing, and self-hosting."
---

The hosted ForeverBetter API gives you managed authentication, private
...
No. **Self-hosting is always an option.** The ForeverBetter API is
