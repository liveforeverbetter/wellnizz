---
title: "API Reference"
description: "Explore the ForeverBetter API by workflow, from authentication and uploads to analysis, agents, and privacy controls."
---

Use this reference to build with the public ForeverBetter API. The
